...
class _$CharacterSerializer implements StructuredSerializer<Character> {
  ...
  Iterable<Object> serialize(Serializers serializers, Character object,
    ...
    final result = <Object>[
      ...
      'culture',
      serializers.serialize(object.culture,
          specifiedType: const FullType(String)),
      'born',
      ...
      serializers.serialize(object.aliases,
          specifiedType:
              const FullType(BuiltList, const [const FullType(String)])),
      'father',
      serializers.serialize(object.father,
          specifiedType: const FullType(String)),
      'mother',
      serializers.serialize(object.mother,
          specifiedType: const FullType(String)),
      'spouse',
      serializers.serialize(object.spouse,
          specifiedType: const FullType(String)),
      'allegiances',
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'gender':
          ...
          break;
        case 'culture':
          result.culture = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'born':
          ...
          break;
        case 'died':
          result.died = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'titles':
        ...
        case 'aliases':
          ...
          break;
        case 'father':
          result.father = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'mother':
          result.mother = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'spouse':
          result.spouse = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'allegiances':
...
class CharacterBuilder implements Builder<Character, CharacterBuilder> {
  ...
  ListBuilder<String> get allegiances =>
      _$this._allegiances ??= new ListBuilder<String>();
  set allegiances(ListBuilder<String> allegiances) =>
      _$this._allegiances = allegiances;
  ...
  ListBuilder<String> get povBooks =>
      _$this._povBooks ??= new ListBuilder<String>();
  set povBooks(ListBuilder<String> povBooks) => _$this._povBooks = povBooks;

  ListBuilder<String> _tvSeries;
  ListBuilder<String> get tvSeries =>
      _$this._tvSeries ??= new ListBuilder<String>();
  set tvSeries(ListBuilder<String> tvSeries) => _$this._tvSeries = tvSeries;

  ListBuilder<String> _playedBy;
  ListBuilder<String> get playedBy =>
      _$this._playedBy ??= new ListBuilder<String>();
