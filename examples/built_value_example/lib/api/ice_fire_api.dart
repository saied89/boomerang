...
final boomerang = Boomerang(converter, http.Client(), 'https://anapioficeandfire.com/api/');

Call<Character> getSnow = Call(Get(), url: 'https://anapioficeandfire.com/api/characters/583');
